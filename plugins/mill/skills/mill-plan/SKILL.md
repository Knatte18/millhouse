...
3. For each batch, render `plugins/mill/templates/plan-batch.md` into `task/plan/NN-<batch-slug>.md` using the pre-quoted tokens dict. Fill Batch Scope + Cards + Batch Tests.
