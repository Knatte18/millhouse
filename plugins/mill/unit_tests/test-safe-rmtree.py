...
Covers: blacklist refusal, containment refusal, junction/symlink-strip before rmtree (regression
guard for the wiki-wipe incident), path-is-junction/symlink refusal, missing-path no-op,
ignore_errors semantics, non-container allowed_root handling, and vanished-entry TOCTOU races in
