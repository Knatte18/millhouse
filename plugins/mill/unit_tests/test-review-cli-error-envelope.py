...
Uses unittest.mock.patch to stub all pre-launch dependencies and the backend run() function,
...
class TestReviewCliErrorEnvelope(unittest.TestCase):
    ...
    def _run_cli_test(
        ...
        Args:
            cli_name: "discussion", "code", or "plan" backend_return: dict to return from
