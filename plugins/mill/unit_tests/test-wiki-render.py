...
Covers: compute_layers algorithm, extended_title, render_order, empty task list, task
grouping/ordering, status markers, proposal file generation, brief text, Depends-on lines, and
sidebar rendering.
"""
