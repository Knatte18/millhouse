...
Tests the absent_status_halt_message helper which generates readable error messages when mill-go
Entry Step 5 encounters a missing _mill/status.md (indicating mill-merge cleanup ran but did not
complete).
"""
