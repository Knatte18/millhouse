...
Tests that _invoke removes the seven named git-state env vars before spawning Claude sessions,
preventing worktree-local config from polluting subprocess author identity.
"""
