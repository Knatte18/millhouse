...
class WikiStoreFormatError(WikiError):
    ...
    Raised before TinyDB indexes the data, so the message can name the offending table/doc/task
    instead of leaking a bare TypeError such as "list indices must be integers or slices, not str".
    """
    pass
