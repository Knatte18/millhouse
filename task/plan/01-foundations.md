...
- **Requirements:**
  ...
  - `test-reviewer-single.py` covers `_reviewer_single.run`:
    ...
    3. `spec.provider == "test_stub"` forwards to `_reviewer_test_stub.run` and the captured prompt round-trips.
