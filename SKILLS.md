...
| [mill-revise-tasks](plugins/mill/skills/mill-revise-tasks/SKILL.md) | Drain the GitHub issue queue into Home.md. One-shot. Proposes a task per issue (new or folded-in), closes consumed issues with a pointer comment, leaves skipped ones alone. |
