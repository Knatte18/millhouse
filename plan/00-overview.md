...
- `plugins/mill/scripts/millpy-fetch-issues.py` *(deleted)*
- `plugins/mill/scripts/millpy-list.py` *(deleted)*
- `plugins/mill/scripts/millpy-worktree.py` *(deleted)*
- `plugins/mill/skills/mill-fetch-issues/SKILL.md` *(deleted)*
- `plugins/mill/skills/mill-list/SKILL.md` *(deleted)*
- `plugins/mill/skills/mill-setup/SKILL.md`
- `plugins/mill/skills/mill-worktree/SKILL.md` *(deleted)*
- `plugins/mill/unit_tests/test-cleanup.py`
- `plugins/mill/unit_tests/test-gh-issues.py` *(created)*
- `plugins/mill/unit_tests/test-millpy-fetch-issues.py` *(deleted)*
- `plugins/mill/unit_tests/test-millpy-worktree.py` *(deleted)*
