...
task_description: |
  Fix nested-junction teardown, Windows verify gate in merge-in, and review-plan --round threading
```
...
batches:
  ...
  - name: review-round-autodiscovery
    ...
    commit_sha: e1a43a0f440b34936b67166058b0a9921c73056d
```
