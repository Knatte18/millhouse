...
task_description: |
  Add first-class Moves/Renames field to plan cards for rename-heavy batches
```

## Timeline

```text
discussing  '2026-06-29T16:20:47Z'
discussion-fix-r3  '2026-06-29T16:46:19Z'
discussed  '2026-06-29T16:46:42Z'
...
batches:
  - name: move-parsing-foundation
    state: approved
    implementer_session: e2550aa5-1a29-41d4-908d-8ddd97037b89
  ...
  - name: review-backends
    ...
    commit_sha: 0583aad64ade6e46bd3e581a654643566defe273
```
