...
task_description: |
  Fix agent-pipeline reliability gaps in finalize/success contract
```
...
discussion-gap-fix-r2  '2026-06-09T12:55:00Z'
discussion-gap-fix-r3  '2026-06-09T12:57:50Z'
...
batches:
  ...
  - name: 'Unit tests: fix-finalize and review-finalize'
    ...
    commit_sha: 525243386fde927c875b742d0e11479d22fff642
```
