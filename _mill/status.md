...
```yaml
phase: approved-accept-session-start-sha-flags
...
task_description: |
  Fix millpy-implement.py finalize to accept (or not require) --session-id/--start-sha
```
...
batches:
  - name: accept-session-start-sha-flags
    ...
    commit_sha: 9e34689d6c2d7f9e4e0cc0ab6f924fca3af4a84d
```
