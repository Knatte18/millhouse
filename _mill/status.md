...
task_description: |
  mill-plan SKILL.md: Phase Plan Review gate, convergence, and DAG-validation correctness bugs
```
...
plan-review-r4  '2026-08-21T10:28:20Z'
...
batches:
  ...
  - name: validator-checks-skill-doc-sync
    ...
    commit_sha: 77cbfa266f356daeaff568ecfc6d05df2932f6a9
```
