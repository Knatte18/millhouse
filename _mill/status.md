...
task_description: |
  mill-merge misjudges worktree topology and mishandles Step 5 squash-restore checkout
```
...
batches:
  ...
  - name: step5-checkout-guard
    ...
    commit_sha: 78b0e58b8fe3d6df0dcc4a08b8100d02869bb72b
```
