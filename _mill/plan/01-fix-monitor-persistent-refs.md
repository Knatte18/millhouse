...
- **Moves:** none
- **Requirements:**
  Read `plugins/mill/skills/mill-go-base/SKILL.md` and `plugins/mill/skills/mill-plan/SKILL.md` (listed in Context: above) for consistency with the design those two files' entry-gate wait sections describe. In the "## Monitor tool" section of `plugins/mill/docs/harness-tool-contracts.md`:
