...
- **Requirements:**
  ...
  - Implement `check_and_restore(worktree: Path, tracked_root: str = "_mill") -> dict`:
    ...
    8. Otherwise return `{"triggered": True, "restored_paths": sorted(restored_paths), "timestamp": _timestamp.now_utc_iso()}`.
