...
- Round 1: `[... 18374 earlier chars omitted ...]\nnostics-gaps/plugins/mill/unit_tests/test-millpy-implement.py", line 607, in test_14_stage_finalize_reads_agent_output\n    self.assertEqual(data["status"], "success")\n    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^\nAssertionError: 'stuck' != 'success'\n- stuck\n+ success\n\n\n======================================================================\nFAIL: test_1_initial_dispatch_success (__main__.TestMillpyImplement.test_1_initial_dispatch_success)\nInitial dispatch: pending batch -> success JSON, batch state running.\n----------------------------------------------------------------------\nTraceback (most recent call last):\n  File "/home/knatte/Code/millhouse/wts/mill-validate-verify-diagnostics-gaps/plugins/mill/unit_tests/test-millpy-implement.py", line 225, in test_1_initial_dispatch_success\n    self.assertEqual(data["status"], "success")\n    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^\nAssertionError: 'stuck' != 'success'\n- stuck\n+ success\n\n\n======================================================================\nFAIL: test_resume_incomplete_finalize_success_when_complete (__main__.TestMillpyImplement.test_resume_incomplete_finalize_success_when_complete)\nFinalize after resume emits success when content commits >= card_count.\n----------------------------------------------------------------------\nTraceback (most recent call last):\n  File "/home/knatte/Code/millhouse/wts/mill-validate-verify-diagnostics-gaps/plugins/mill/unit_tests/test-millpy-implement.py", line 1901, in test_resume_incomplete_finalize_success_when_complete\n    self.assertEqual(data["status"], "success")\n    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^\nAssertionError: 'stuck' != 'success'\n- stuck\n+ success\n\n\n----------------------------------------------------------------------\nRan 74 tests in 0.190s\n\nFAILED (failures=8, errors=1)\nRunning 1 tests across 12 worker(s).\n--- FAIL test-millpy-implement.py (0.3s) ---\n\nSlowest 10:\n     0.3s  test-millpy-implement.py\n\nFAIL -- 1 of 1 in 0.3s: ['test-millpy-implement.py']` — confirmed via a clean `git archive main` checkout that this exact 8-failures/1-error set (same test names, same assertion messages, "Ran N tests ... FAILED (failures=8, errors=1)") reproduces byte-for-byte on `main` before any of this batch's commits. Pre-existing, unrelated to this batch's cards (20-24); no plan edit made.
