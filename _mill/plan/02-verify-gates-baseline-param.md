...
- **Moves:** none
- **Requirements:**
  1. Add `module_verify_baseline: str | None = None` as a new keyword-only parameter to `_run_verify_gates` (`_implementer_common.py:642-647`), placed after the existing `module_wide_verify_cmd` parameter.
