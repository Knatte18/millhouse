...
- **Requirements:**
  ...
  - Insert a second new sentence immediately before step 3 (`"3. **Confirm \`mill-receiving-review\` is loaded ..."`) — i.e. after ALL of step 2's own content, which includes the **Agent-mode properties:** paragraph followed by the full **Subprocess/psmux branch** prose and its bash blocks; "before step 3" is the unambiguous anchor, not any particular paragraph inside step 2:
