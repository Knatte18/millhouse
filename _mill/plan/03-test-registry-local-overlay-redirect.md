...
- **Requirements:**
  ...
  - Register the new function in `main()`'s `tests = [...]` list (`plugins/mill/unit_tests/test-reviewers.py`, ~line 1150), appended immediately after the existing `test_load_falls_back_to_reviewers_yaml` entry, grouped with the other `test_load_*` entries.
