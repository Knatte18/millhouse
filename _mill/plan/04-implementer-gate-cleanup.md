...
### Card 20: Delete _corroborate_batch_failure
...
### Card 22: Update the four internal _run_verify_gates call sites
...
### Card 24: Update millpy-implement.py's finalize and full-stage call sites
...
### Card 25: Update millpy-fix.py's two call sites
...
### Card 26: Update the unit tests for the deleted gate branches
