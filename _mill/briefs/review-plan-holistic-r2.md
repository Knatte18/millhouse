...
You are an independent plan reviewer for **compute_baseline: use the task worktree's own pre-edit state, not a parent-branch checkout**.
...
Every unprefixed path below is relative to `/home/hanf/Code/millhouse/wts/baseline-uses-worktree-not-checkout`.
- `wiki/` paths are relative to `/home/hanf/Code/millhouse/wiki`

## Files included (N=39)

- _mill/plan/00-overview.md
- _mill/plan/01-status-baseline-fields.md
- _mill/plan/02-verify-baseline-core.md
- _mill/plan/03-implement-baseline-stage.md
- _mill/plan/04-implementer-gate-cleanup.md
- _mill/plan/05-merge-in-baseline-recompute.md
- _mill/plan/06-cleanup-orphan-removal.md
- _mill/plan/07-skill-docs-baseline.md
...
Write your full report to this file: /home/hanf/Code/millhouse/wts/baseline-uses-worktree-not-checkout/_mill/briefs/review-plan-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/millhouse/wts/baseline-uses-worktree-not-checkout/_mill/briefs/review-plan-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/millhouse/wts/baseline-uses-worktree-not-checkout/_mill/briefs/review-plan-holistic-r2.out.md`
