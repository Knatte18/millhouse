...
You are an independent plan reviewer for **mill-merge / mill-merge-in: brief-staging path bug and easy-to-miss caching instruction**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/mill-merge-family-doc-gaps`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=5)

- _mill/plan/00-overview.md
- _mill/plan/01-doc-gaps-fixes.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-merge-family-doc-gaps/_mill/briefs/review-plan-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-merge-family-doc-gaps/_mill/briefs/review-plan-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-merge-family-doc-gaps/_mill/briefs/review-plan-holistic-r2.out.md`
