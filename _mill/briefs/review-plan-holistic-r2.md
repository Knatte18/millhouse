...
You are an independent plan reviewer for **plan validator and wiki-guard hook false positives**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/tooling-false-positives`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=12)

- _mill/plan/00-overview.md
- _mill/plan/01-wiki-guard.md
- _mill/plan/02-hook-install.md
- _mill/plan/03-symbol-resolution.md
- _mill/plan/04-symbol-resolution-tests.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/tooling-false-positives/_mill/briefs/review-plan-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/tooling-false-positives/_mill/briefs/review-plan-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/tooling-false-positives/_mill/briefs/review-plan-holistic-r2.out.md`
