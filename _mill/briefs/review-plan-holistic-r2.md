...
You are an independent plan reviewer for **_verify_baseline.py transient worktrees can be orphaned when the task worktree is force-removed mid-computation**.
...
- /home/knatte/Code/millhouse/wts/verify-baseline-nested-worktree-orphan-risk/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/verify-baseline-nested-worktree-orphan-risk/_mill/plan/01-worktree-remove-safe-prune.md
- /home/knatte/Code/millhouse/wts/verify-baseline-nested-worktree-orphan-risk/plugins/mill/scripts/_worktree.py
- /home/knatte/Code/millhouse/wts/verify-baseline-nested-worktree-orphan-risk/plugins/mill/scripts/_verify_baseline.py
- /home/knatte/Code/millhouse/wts/verify-baseline-nested-worktree-orphan-risk/plugins/mill/unit_tests/test-worktree.py

## Plan files to review
- Overview: `/home/knatte/Code/millhouse/wts/verify-baseline-nested-worktree-orphan-risk/_mill/plan/00-overview.md`
- Batches:
- `/home/knatte/Code/millhouse/wts/verify-baseline-nested-worktree-orphan-risk/_mill/plan/01-worktree-remove-safe-prune.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/verify-baseline-nested-worktree-orphan-risk/_mill/briefs/review-plan-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/verify-baseline-nested-worktree-orphan-risk/_mill/briefs/review-plan-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/verify-baseline-nested-worktree-orphan-risk/_mill/briefs/review-plan-holistic-r2.out.md`
