...
You are an independent plan reviewer for **Monitor tool: persistent:true still referenced in mill-go-base and mill-plan despite no such param**.
...
Every unprefixed path below is relative to `/home/hanf/Code/millhouse/wts/monitor-persistent-true-still-referenced`.
- `wiki/` paths are relative to `/home/hanf/Code/millhouse/wiki`

## Files included (N=7)

- _mill/plan/00-overview.md
- _mill/plan/01-fix-monitor-persistent-refs.md
...
Write your full report to this file: /home/hanf/Code/millhouse/wts/monitor-persistent-true-still-referenced/_mill/briefs/review-plan-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/millhouse/wts/monitor-persistent-true-still-referenced/_mill/briefs/review-plan-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/millhouse/wts/monitor-persistent-true-still-referenced/_mill/briefs/review-plan-holistic-r2.out.md`
