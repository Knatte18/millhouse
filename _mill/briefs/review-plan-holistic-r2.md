...
You are an independent plan reviewer for **Fix nested mill layout paths, whole-repo formatter drift, and stacked-branch PR cleanup**. You evaluate the complete plan (all batches) and produce a structured review.
