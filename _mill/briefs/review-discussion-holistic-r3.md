...
You are an independent discussion reviewer for **Fix plan validator Moves-target gap, code-review backtick parser, and mill-start encoding crash**. Round **3**. Reviewer model: **opushigh**.
