...
You are an independent code reviewer for **mill-plan/mill-start planning-process gaps, round 2**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/mill-plan-process-gaps-r2`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=16)

- _mill/plan/00-overview.md
- _mill/plan/01-doc-fixes.md
- _mill/plan/02-allow-missing-refs.md
- _mill/plan/03-write-brief-warning.md
- _mill/plan/04-cross-batch-build-break.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-plan-process-gaps-r2/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-plan-process-gaps-r2/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-plan-process-gaps-r2/_mill/briefs/review-code-holistic-r1.out.md`
