...
You are an independent code reviewer for **Fix mid-batch stop recovery and fixer false-success in agent-dispatch mode**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\_mill\plan\00-overview.md
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\_mill\plan\01-finalize-incomplete-core.md
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\_mill\plan\02-resume-path-and-brief-token.md
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\_mill\plan\03-fixer-brief-commit-guard.md
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\_mill\plan\04-millgo-incomplete-routing.md
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\scripts\_implementer_common.py
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\scripts\_subprocess_util.py
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\unit_tests\test-implementer-common.py
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\templates\implementer-brief.md
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\scripts\_render.py
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\scripts\_status.py
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\scripts\_agent_dispatch.py
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\scripts\_cleanliness.py
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\scripts\millpy-implement.py
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\unit_tests\test-millpy-implement.py
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\unit_tests\test-language-skills-directive.py
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\integration_tests\test-go-assets.py
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\templates\fixer-batch-brief.md
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\templates\fixer-holistic-brief.md
- C:\Code\millhouse\wts\mill-agent-dispatch-gaps\plugins\mill\skills\mill-go\SKILL.md

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\mill-agent-dispatch-gaps\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\mill-agent-dispatch-gaps\_mill\plan\01-finalize-incomplete-core.md`
  - `C:\Code\millhouse\wts\mill-agent-dispatch-gaps\_mill\plan\02-resume-path-and-brief-token.md`
  - `C:\Code\millhouse\wts\mill-agent-dispatch-gaps\_mill\plan\03-fixer-brief-commit-guard.md`
