...
You are an independent code reviewer for **mill-go verify/cleanup gates misclassify build-tag deletions and round-suffixed phases**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- /home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/_mill/plan/01-go-build-tag-directory-deletion-guard.md
- /home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/_mill/plan/02-cleanup-live-phase-classification.md
- /home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/plugins/mill/scripts/_implementer_common.py
- /home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/plugins/mill/unit_tests/test-implementer-common.py
- /home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/plugins/mill/scripts/millpy-cleanup.py
- /home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/plugins/mill/unit_tests/test-cleanup.py

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/_mill/plan/01-go-build-tag-directory-deletion-guard.md`
  - `/home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/_mill/plan/02-cleanup-live-phase-classification.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-go-verify-gate-misclassification/_mill/briefs/review-code-holistic-r1.out.md`
