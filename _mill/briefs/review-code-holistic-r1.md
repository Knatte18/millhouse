...
You are an independent code reviewer for **mill-go-base: take the subagent report from the SubagentHandback message**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/subagent-handback-report`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=18)

- _mill/plan/00-overview.md
- _mill/plan/01-agent-dispatch-core.md
- _mill/plan/02-sibling-skill-wording.md
- _mill/plan/03-script-wording.md
- _mill/plan/04-test-comments.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/subagent-handback-report/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/subagent-handback-report/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/subagent-handback-report/_mill/briefs/review-code-holistic-r1.out.md`
