...
You are an independent code reviewer for **Fix prose skill: staleness rule and missing loads**.
...
Every unprefixed path below is relative to `/home/hanf/Code/millhouse/wts/prose-skill-gaps`.
- `wiki/` paths are relative to `/home/hanf/Code/millhouse/wiki`

## Files included (N=34)

- _mill/plan/00-overview.md
- _mill/plan/01-prose-rules-and-markdown-retire.md
- _mill/plan/02-dispatch-directive.md
- _mill/plan/03-load-directive-sites-and-test.md
- _mill/plan/04-inlined-style-blocks.md
...
Write your full report to this file: /home/hanf/Code/millhouse/wts/prose-skill-gaps/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/millhouse/wts/prose-skill-gaps/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/millhouse/wts/prose-skill-gaps/_mill/briefs/review-code-holistic-r1.out.md`
