...
You are an independent code reviewer for **pipeline.autonomous_mode warns as unknown config key on every mill invocation**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- /home/knatte/Code/millhouse/wts/mill-config-autonomous-mode-unknown-key/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/mill-config-autonomous-mode-unknown-key/_mill/plan/01-deprecated-key-suppression.md
- /home/knatte/Code/millhouse/wts/mill-config-autonomous-mode-unknown-key/plugins/mill/scripts/_config.py
- /home/knatte/Code/millhouse/wts/mill-config-autonomous-mode-unknown-key/plugins/mill/unit_tests/test-config.py

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-config-autonomous-mode-unknown-key/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-config-autonomous-mode-unknown-key/_mill/plan/01-deprecated-key-suppression.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-config-autonomous-mode-unknown-key/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-config-autonomous-mode-unknown-key/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-config-autonomous-mode-unknown-key/_mill/briefs/review-code-holistic-r1.out.md`
