...
You are an independent code reviewer for **_plan_validate.py: Batch Index/batch-file verify: drift, flattened-fence, and large-file-citation gaps**.
...
- /home/knatte/Code/millhouse/wts/plan-validate-batch-index-drift-and-misc-checks/_mill/plan/00-overview.md
...
- /home/knatte/Code/millhouse/wts/plan-validate-batch-index-drift-and-misc-checks/plugins/mill/scripts/_plan_validate.py
...
- /home/knatte/Code/millhouse/wts/plan-validate-batch-index-drift-and-misc-checks/plugins/mill/skills/mill-plan/SKILL.md
- /home/knatte/Code/millhouse/wts/plan-validate-batch-index-drift-and-misc-checks/plugins/mill/scripts/_plan_dag.py

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/plan-validate-batch-index-drift-and-misc-checks/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/plan-validate-batch-index-drift-and-misc-checks/_mill/plan/01-validator-checks.md`
  - `/home/knatte/Code/millhouse/wts/plan-validate-batch-index-drift-and-misc-checks/_mill/plan/02-validator-tests.md`
  - `/home/knatte/Code/millhouse/wts/plan-validate-batch-index-drift-and-misc-checks/_mill/plan/03-fix-table-docs.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/plan-validate-batch-index-drift-and-misc-checks/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/plan-validate-batch-index-drift-and-misc-checks/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/plan-validate-batch-index-drift-and-misc-checks/_mill/briefs/review-code-holistic-r1.out.md`
