...
You are an independent code reviewer for **mill-plan autonomy guidance and validation gaps: fork scope violations, missing anti-pause guidance, no mechanical Context/Edits completeness check**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- /home/knatte/Code/millhouse/wts/mill-plan-autonomy-and-validation-gaps/_mill/plan/00-overview.md
...
- /home/knatte/Code/millhouse/wts/mill-plan-autonomy-and-validation-gaps/plugins/mill/scripts/_plan_validate.py
- /home/knatte/Code/millhouse/wts/mill-plan-autonomy-and-validation-gaps/plugins/mill/unit_tests/test-plan-validate.py
- /home/knatte/Code/millhouse/wts/mill-plan-autonomy-and-validation-gaps/plugins/mill/skills/mill-plan/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-plan-autonomy-and-validation-gaps/plugins/mill/skills/mill-go/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-plan-autonomy-and-validation-gaps/plugins/mill/scripts/_review_common.py

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-plan-autonomy-and-validation-gaps/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-plan-autonomy-and-validation-gaps/_mill/plan/01-context-completeness-check.md`
  - `/home/knatte/Code/millhouse/wts/mill-plan-autonomy-and-validation-gaps/_mill/plan/02-plan-guardrails-and-anti-pause.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-plan-autonomy-and-validation-gaps/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-plan-autonomy-and-validation-gaps/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-plan-autonomy-and-validation-gaps/_mill/briefs/review-code-holistic-r1.out.md`
