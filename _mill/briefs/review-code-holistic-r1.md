...
You are an independent code reviewer for **Fix millpy-implement.py finalize to accept (or not require) --session-id/--start-sha**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\implement-finalize-session-id\_mill\plan\00-overview.md
- C:\Code\millhouse\wts\implement-finalize-session-id\_mill\plan\01-accept-session-start-sha-flags.md
- C:\Code\millhouse\wts\implement-finalize-session-id\plugins\mill\scripts\millpy-implement.py
- C:\Code\millhouse\wts\implement-finalize-session-id\plugins\mill\scripts\_implementer_common.py
- C:\Code\millhouse\wts\implement-finalize-session-id\plugins\mill\scripts\_status.py
- C:\Code\millhouse\wts\implement-finalize-session-id\plugins\mill\unit_tests\test-fix-finalize.py
- C:\Code\millhouse\wts\implement-finalize-session-id\plugins\mill\unit_tests\test-millpy-implement.py
- C:\Code\millhouse\wts\implement-finalize-session-id\plugins\mill\scripts\millpy-fix.py

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\implement-finalize-session-id\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\implement-finalize-session-id\_mill\plan\01-accept-session-start-sha-flags.md`
