...
You are an independent code reviewer for **Fix implement finalize correctness: mid-batch stop recovery, commit-count guard, and empty-commit detection**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\mill-implement-finalize-gaps\_mill\plan\00-overview.md
- C:\Code\millhouse\wts\mill-implement-finalize-gaps\_mill\plan\01-code-fixes-and-tests.md
- C:\Code\millhouse\wts\mill-implement-finalize-gaps\_mill\plan\02-docs-and-template.md
- C:\Code\millhouse\wts\mill-implement-finalize-gaps\plugins\mill\scripts\_implementer_common.py
- C:\Code\millhouse\wts\mill-implement-finalize-gaps\plugins\mill\unit_tests\test-implementer-common.py
- C:\Code\millhouse\wts\mill-implement-finalize-gaps\plugins\mill\templates\implementer-brief.md
- C:\Code\millhouse\wts\mill-implement-finalize-gaps\plugins\mill\skills\mill-go\SKILL.md

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\mill-implement-finalize-gaps\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\mill-implement-finalize-gaps\_mill\plan\01-code-fixes-and-tests.md`
  - `C:\Code\millhouse\wts\mill-implement-finalize-gaps\_mill\plan\02-docs-and-template.md`
