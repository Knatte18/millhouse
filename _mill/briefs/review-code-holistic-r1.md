...
You are an independent code reviewer for **Fix codeguide-update scope resolution on stacked branches and resolve_scope.py branch-name parsing**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\_mill\plan\00-overview.md
...
- C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\plugins\codeguide\scripts\resolve_scope.py
- C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\plugins\codeguide\unit_tests\test-resolve-scope.py
- C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\plugins\codeguide\skills\codeguide-update\SKILL.md
- C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\plugins\mill\scripts\_parent_branch.py
- C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\plugins\mill\unit_tests\test-parent-branch.py
- C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\plugins\mill\scripts\_paths.py
- C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\plugins\mill\scripts\_config.py
- C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\plugins\mill\skills\git-commit\SKILL.md
- C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\plugins\mill\skills\mill-merge-in\SKILL.md

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\_mill\plan\01-resolve-scope-core.md`
  - `C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\_mill\plan\02-parent-branch-helper.md`
  - `C:\Code\millhouse\wts\codeguide-scope-resolution-fixes\_mill\plan\03-wire-up-callers.md`
