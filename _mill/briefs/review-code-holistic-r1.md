...
You are an independent code reviewer for **Fix mill-ghissues-to-tasks to refuse fold-ins into done and deferred tasks**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\ghissues-skill-fold-guard\_mill\plan\00-overview.md
- C:\Code\millhouse\wts\ghissues-skill-fold-guard\_mill\plan\01-fold-guard-allowlist.md
- C:\Code\millhouse\wts\ghissues-skill-fold-guard\plugins\mill\scripts\millpy-fold.py
- C:\Code\millhouse\wts\ghissues-skill-fold-guard\plugins\mill\scripts\wiki\__init__.py
- C:\Code\millhouse\wts\ghissues-skill-fold-guard\plugins\mill\scripts\wiki\_render.py
- C:\Code\millhouse\wts\ghissues-skill-fold-guard\plugins\mill\scripts\wiki\_parse.py
- C:\Code\millhouse\wts\ghissues-skill-fold-guard\plugins\mill\unit_tests\test-fold.py
- C:\Code\millhouse\wts\ghissues-skill-fold-guard\plugins\mill\skills\mill-fold\SKILL.md
- C:\Code\millhouse\wts\ghissues-skill-fold-guard\plugins\mill\skills\mill-ghissues-to-tasks\SKILL.md
- C:\Code\millhouse\wts\ghissues-skill-fold-guard\CLAUDE.md

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\ghissues-skill-fold-guard\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\ghissues-skill-fold-guard\_mill\plan\01-fold-guard-allowlist.md`
