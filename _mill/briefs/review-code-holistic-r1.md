...
You are an independent code reviewer for **Fix mill-merge-in stale ref check, PowerShell 5.1 ConvertTo-Json, and _status str-path crash**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\mill-script-fixes\_mill\plan\00-overview.md
...
- C:\Code\millhouse\wts\mill-script-fixes\plugins\mill\skills\mill-merge-in\SKILL.md
- C:\Code\millhouse\wts\mill-script-fixes\plugins\mill\integration_tests\test-merge.py
- C:\Code\millhouse\wts\mill-script-fixes\plugins\mill\scripts\_worktree.py
- C:\Code\millhouse\wts\mill-script-fixes\plugins\mill\unit_tests\test-worktree.py
- C:\Code\millhouse\wts\mill-script-fixes\plugins\mill\scripts\_status.py
- C:\Code\millhouse\wts\mill-script-fixes\plugins\mill\unit_tests\test-status.py

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\mill-script-fixes\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\mill-script-fixes\_mill\plan\01-mill-merge-in-stale-ref.md`
  - `C:\Code\millhouse\wts\mill-script-fixes\_mill\plan\02-worktree-asarray.md`
  - `C:\Code\millhouse\wts\mill-script-fixes\_mill\plan\03-status-path-typeerror.md`
