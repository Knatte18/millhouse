...
You are an independent code reviewer for **Fix prepare-retry atomicity, partial-batch finalize routing, and envelope field parity**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\_mill\plan\00-overview.md
- C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\_mill\plan\01-implement-pipeline.md
- C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\_mill\plan\02-merge-in-cli-parity.md
- C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\plugins\mill\scripts\millpy-fix.py
- C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\plugins\mill\scripts\millpy-implement.py
- C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\plugins\mill\scripts\_subprocess_util.py
- C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\plugins\mill\scripts\_implementer_common.py
- C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\plugins\mill\unit_tests\test-millpy-implement.py
- C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\plugins\mill\unit_tests\test-implementer-common.py
- C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\plugins\mill\scripts\millpy-merge-in-subagent.py
- C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\plugins\mill\unit_tests\test-millpy-merge-in-subagent.py

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\_mill\plan\01-implement-pipeline.md`
  - `C:\Code\millhouse\wts\mill-pipeline-finalize-gaps\_mill\plan\02-merge-in-cli-parity.md`
