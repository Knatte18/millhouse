...
You are an independent code reviewer for **Review output reliability: metadata misattribution and factual-accuracy failures**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/review-output-reliability-and-attribution-bugs`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=10)

- _mill/plan/00-overview.md
- _mill/plan/01-review-output-attribution-reliability.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/review-output-reliability-and-attribution-bugs/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/review-output-reliability-and-attribution-bugs/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/review-output-reliability-and-attribution-bugs/_mill/briefs/review-code-holistic-r1.out.md`
