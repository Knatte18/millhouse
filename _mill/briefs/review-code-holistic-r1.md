...
You are an independent code reviewer for **millpy-review-plan: verdict/envelope disagreement and reviewer_model mis-recording**.
...
- /home/knatte/Code/millhouse/wts/review-plan-verdict-envelope-model-bugs/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/review-plan-verdict-envelope-model-bugs/_mill/plan/01-mechanism-claim-rule.md
...
- Overview: `/home/knatte/Code/millhouse/wts/review-plan-verdict-envelope-model-bugs/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/review-plan-verdict-envelope-model-bugs/_mill/plan/01-mechanism-claim-rule.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/review-plan-verdict-envelope-model-bugs/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/review-plan-verdict-envelope-model-bugs/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/review-plan-verdict-envelope-model-bugs/_mill/briefs/review-code-holistic-r1.out.md`
