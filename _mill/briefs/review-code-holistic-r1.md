...
You are an independent code reviewer for **Wiki daemon error-log leak and stale plugin-cache config validation produce misleading noise**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- /home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/_mill/plan/01-daemon-noise-fixes.md
- /home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/_mill/plan/02-review-common-load-config-dedup.md
- /home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/plugins/mill/scripts/_daemon.py
- /home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/plugins/mill/scripts/wiki/_client.py
- /home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/plugins/mill/scripts/wiki/_server.py
- /home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/plugins/mill/unit_tests/test-wiki-daemon.py
- /home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/plugins/mill/scripts/_config.py
...
- Overview: `/home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/_mill/plan/01-daemon-noise-fixes.md`
  - `/home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/_mill/plan/02-review-common-load-config-dedup.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-background-noise-and-stale-config/_mill/briefs/review-code-holistic-r1.out.md`
