...
You are an independent code reviewer for **Auto-approve on review-round cap**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/review-cap-auto-approve`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=12)

- _mill/plan/00-overview.md
- _mill/plan/01-config-schema-auto-approve-on-cap.md
- _mill/plan/02-mill-plan-auto-approve-wiring.md
- _mill/plan/03-mill-go-base-batch-auto-approve-wiring.md
- _mill/plan/04-mill-go-base-holistic-auto-approve-wiring.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/review-cap-auto-approve/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/review-cap-auto-approve/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/review-cap-auto-approve/_mill/briefs/review-code-holistic-r1.out.md`
