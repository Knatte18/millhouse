...
You are an independent code reviewer for **Auto-name task sessions <slug>:<phase>**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/session-naming`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=34)

- _mill/plan/00-overview.md
- _mill/plan/01-tasks-render.md
- _mill/plan/02-keybindings.md
- _mill/plan/03-session-tasks-cli.md
- _mill/plan/04-spawn-wiring.md
- _mill/plan/05-setup-docs.md
- mill-config.yaml
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/session-naming/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/session-naming/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/session-naming/_mill/briefs/review-code-holistic-r1.out.md`
