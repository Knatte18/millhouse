...
You are an independent code reviewer for **Fix unit test suite failures, spurious review warning, and implementer verify-gate gaps**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\_mill\plan\00-overview.md
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\_mill\plan\01-review-common-fixes.md
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\_mill\plan\02-ascii-arrow-fix.md
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\_mill\plan\03-implementer-verify-gate.md
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\_mill\plan\04-implementer-guardrail.md
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\unit_tests\test-review-common-guard.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\scripts\_review_common.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\unit_tests\test-review-common.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\unit_tests\test-guards.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\unit_tests\test-claude-sub.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\unit_tests\test-plan-validate.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\scripts\millpy-merge-in-subagent.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\scripts\_implementer_common.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\scripts\_plan_dag.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\unit_tests\test-millpy-fix.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\scripts\millpy-implement.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\scripts\millpy-fix.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\unit_tests\test-implementer-common.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\unit_tests\test-millpy-implement.py
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\templates\implementer-brief.md
- C:\Code\millhouse\wts\mill-test-and-implementer-reliability\plugins\mill\agents\mill-implementer.md

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\mill-test-and-implementer-reliability\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\mill-test-and-implementer-reliability\_mill\plan\01-review-common-fixes.md`
  - `C:\Code\millhouse\wts\mill-test-and-implementer-reliability\_mill\plan\02-ascii-arrow-fix.md`
  - `C:\Code\millhouse\wts\mill-test-and-implementer-reliability\_mill\plan\03-implementer-verify-gate.md`
