...
You are an independent code reviewer for **Verify/build gates leak shell state and ignore nested Go modules**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- /home/knatte/Code/millhouse/wts/mill-verify-gate-scoping-bugs/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/mill-verify-gate-scoping-bugs/_mill/plan/01-bug1-holistic-verify-subshell-wrap.md
- /home/knatte/Code/millhouse/wts/mill-verify-gate-scoping-bugs/_mill/plan/02-bug2-nested-go-module-cwd.md
- /home/knatte/Code/millhouse/wts/mill-verify-gate-scoping-bugs/plugins/mill/scripts/millpy-fix.py
- /home/knatte/Code/millhouse/wts/mill-verify-gate-scoping-bugs/plugins/mill/unit_tests/test-millpy-fix.py
...
- /home/knatte/Code/millhouse/wts/mill-verify-gate-scoping-bugs/plugins/mill/scripts/_plan_validate.py

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-verify-gate-scoping-bugs/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-verify-gate-scoping-bugs/_mill/plan/01-bug1-holistic-verify-subshell-wrap.md`
  - `/home/knatte/Code/millhouse/wts/mill-verify-gate-scoping-bugs/_mill/plan/02-bug2-nested-go-module-cwd.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-verify-gate-scoping-bugs/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-verify-gate-scoping-bugs/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-verify-gate-scoping-bugs/_mill/briefs/review-code-holistic-r1.out.md`
