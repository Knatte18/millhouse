...
You are an independent code reviewer for **Fix plan validator Moves-target gap, code-review backtick parser, and mill-start encoding crash**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\mill-plan-and-start-gaps\_mill\plan\00-overview.md
- C:\Code\millhouse\wts\mill-plan-and-start-gaps\_mill\plan\01-moves-target-docs-and-messages.md
- C:\Code\millhouse\wts\mill-plan-and-start-gaps\_mill\plan\02-parse-batch-refs-leading-token.md
- C:\Code\millhouse\wts\mill-plan-and-start-gaps\_mill\plan\03-mill-start-utf8-fix.md
- C:\Code\millhouse\wts\mill-plan-and-start-gaps\plugins\mill\templates\plan-overview.md
- C:\Code\millhouse\wts\mill-plan-and-start-gaps\plugins\mill\skills\mill-plan\SKILL.md
- C:\Code\millhouse\wts\mill-plan-and-start-gaps\plugins\mill\scripts\_plan_validate.py
- C:\Code\millhouse\wts\mill-plan-and-start-gaps\plugins\mill\scripts\_review_common.py
- C:\Code\millhouse\wts\mill-plan-and-start-gaps\plugins\mill\unit_tests\test-review-common.py
- C:\Code\millhouse\wts\mill-plan-and-start-gaps\plugins\mill\unit_tests\test-plan-validate.py
- C:\Code\millhouse\wts\mill-plan-and-start-gaps\plugins\mill\skills\mill-start\SKILL.md

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\mill-plan-and-start-gaps\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\mill-plan-and-start-gaps\_mill\plan\01-moves-target-docs-and-messages.md`
  - `C:\Code\millhouse\wts\mill-plan-and-start-gaps\_mill\plan\02-parse-batch-refs-leading-token.md`
  - `C:\Code\millhouse\wts\mill-plan-and-start-gaps\_mill\plan\03-mill-start-utf8-fix.md`
