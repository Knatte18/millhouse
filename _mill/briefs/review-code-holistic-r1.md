...
You are an independent code reviewer for **Split mill-ghissues-to-tasks into source adapter + source-agnostic analysis**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\_mill\plan\00-overview.md
...
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\_mill\discussion.md
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\scripts\_gh_issues.py
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\unit_tests\test-gh-issues.py
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\scripts\_sandbox_report.py
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\unit_tests\test-sandbox-report.py
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\templates\review-output.schema.md
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\templates\triage-report.schema.md
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\skills\mill-ghissues-to-tasks\SKILL.md
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\skills\mill-receiving-review\SKILL.md
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\skills\mill-fold\SKILL.md
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\scripts\millpy-fold.py
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\scripts\wiki\_client.py
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\scripts\_paths.py
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\skills\mill-triage-to-tasks\SKILL.md
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\skills\mill-report-to-tasks\SKILL.md
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\plugins\mill\skills\mill-skills-index\SKILL.md
- C:\Code\millhouse\wts\mill-ghissues-source-adapter\SKILLS.md

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\mill-ghissues-source-adapter\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\mill-ghissues-source-adapter\_mill\plan\01-contract-adapters.md`
  - `C:\Code\millhouse\wts\mill-ghissues-source-adapter\_mill\plan\02-triage-to-tasks-skill.md`
  - `C:\Code\millhouse\wts\mill-ghissues-source-adapter\_mill\plan\03-report-to-tasks-skill.md`
