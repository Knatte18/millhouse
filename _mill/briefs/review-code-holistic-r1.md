...
You are an independent code reviewer for **_plan_validate false positives block plan authoring**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- /home/knatte/Code/millhouse/wts/mill-plan-validate-false-positives/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/mill-plan-validate-false-positives/_mill/plan/01-fix-plan-validate-false-positives.md
- /home/knatte/Code/millhouse/wts/mill-plan-validate-false-positives/plugins/mill/scripts/_plan_validate.py
- /home/knatte/Code/millhouse/wts/mill-plan-validate-false-positives/plugins/mill/unit_tests/test-plan-validate.py
- /home/knatte/Code/millhouse/wts/mill-plan-validate-false-positives/plugins/mill/scripts/_review_common.py

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-plan-validate-false-positives/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-plan-validate-false-positives/_mill/plan/01-fix-plan-validate-false-positives.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-plan-validate-false-positives/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-plan-validate-false-positives/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-plan-validate-false-positives/_mill/briefs/review-code-holistic-r1.out.md`
