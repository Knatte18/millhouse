...
You are an independent code reviewer for **mill-start Explore: Agent(subagent_type: fork) dispatch fails to perform assigned investigation**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/mill-start-explore-fork-dispatch-failure`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=5)

- _mill/plan/00-overview.md
- _mill/plan/01-fork-echo-fallback.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-start-explore-fork-dispatch-failure/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-start-explore-fork-dispatch-failure/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-start-explore-fork-dispatch-failure/_mill/briefs/review-code-holistic-r1.out.md`
