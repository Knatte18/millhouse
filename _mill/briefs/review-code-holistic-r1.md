...
You are an independent code reviewer for **mill-setup/wiki/docs/build-env: misc small bugs, round 3**.
...
Every unprefixed path below is relative to `/home/hanf/Code/millhouse/wts/mill-setup-wiki-doc-misc-r3`.
- `wiki/` paths are relative to `/home/hanf/Code/millhouse/wiki`

## Files included (N=12)

- _mill/plan/00-overview.md
- _mill/plan/01-mill-triage-title-escape.md
- _mill/plan/02-handoff-draft-order.md
- _mill/plan/03-claude-settings-denylist.md
- _mill/plan/04-golangci-lint-sandbox-fallback.md
...
Write your full report to this file: /home/hanf/Code/millhouse/wts/mill-setup-wiki-doc-misc-r3/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/millhouse/wts/mill-setup-wiki-doc-misc-r3/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/millhouse/wts/mill-setup-wiki-doc-misc-r3/_mill/briefs/review-code-holistic-r1.out.md`
