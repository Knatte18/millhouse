...
You are an independent code reviewer for **Fix agent-pipeline reliability gaps in finalize/success contract**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\agent-pipeline-reliability\_mill\plan\00-overview.md
- C:\Code\millhouse\wts\agent-pipeline-reliability\_mill\plan\01-core-fix.md
- C:\Code\millhouse\wts\agent-pipeline-reliability\_mill\plan\02-review-cli-finalize.md
- C:\Code\millhouse\wts\agent-pipeline-reliability\_mill\plan\03-skill-updates.md
- C:\Code\millhouse\wts\agent-pipeline-reliability\_mill\plan\04-unit-tests.md
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\scripts\_implementer_common.py
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\scripts\millpy-fix.py
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\scripts\_review_code.py
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\scripts\_review_common.py
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\scripts\millpy-review-code.py
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\scripts\_review_plan.py
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\scripts\millpy-review-plan.py
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\scripts\_review_discussion.py
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\scripts\millpy-review-discussion.py
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\skills\mill-go\SKILL.md
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\skills\mill-start\SKILL.md
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\unit_tests\test-implementer-common.py
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\unit_tests\test-fix-finalize.py
- C:\Code\millhouse\wts\agent-pipeline-reliability\plugins\mill\unit_tests\test-review-finalize.py

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\agent-pipeline-reliability\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\agent-pipeline-reliability\_mill\plan\01-core-fix.md`
  - `C:\Code\millhouse\wts\agent-pipeline-reliability\_mill\plan\02-review-cli-finalize.md`
  - `C:\Code\millhouse\wts\agent-pipeline-reliability\_mill\plan\03-skill-updates.md`
