...
You are an independent code reviewer for **mill-go-base: remove subprocess/psmux dispatch branches**.
...
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/plan/00-overview.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/plan/01-regression-guard.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/plan/02-strip-subprocess-dispatch.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/plan/03-treeguard-dedup.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/plan/04-extract-cold-path.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/plan/05-renumber-and-siblings.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/plugins/mill/unit_tests/test-mill-go-base-agent-only.py
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/plugins/mill/skills/mill-go-base/SKILL.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/plugins/mill/skills/mill-go-base/resume.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/plugins/mill/skills/mill-go-base/holistic-review.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/plugins/mill/skills/mill-go-base/handoff.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/plugins/mill/unit_tests/test-skill-helper-drift.py
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/plugins/mill/skills/mill-go/SKILL.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/plugins/mill/skills/mill-go2/SKILL.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/SKILLS.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/plugins/mill/unit_tests/test-mill-go-variants.py
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/plugins/mill/unit_tests/run-all.py
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/discussion.md
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/plugins/mill/scripts/millpy-skills-index.py
- /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/plugins/mill/skills/mill-skills-index/SKILL.md

## Plan + source files to review
- Overview: `/home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/plan/01-regression-guard.md`
  - `/home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/plan/02-strip-subprocess-dispatch.md`
  - `/home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/plan/03-treeguard-dedup.md`
...
Write your full report to this file: /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/millhouse/wts/mill-go-base-agent-dispatch-only/_mill/briefs/review-code-holistic-r1.out.md`
