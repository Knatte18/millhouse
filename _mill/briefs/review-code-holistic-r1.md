...
You are an independent code reviewer for **mill-vscode/mill-spawn leak CLAUDE_CODE_CHILD_SESSION into spawned VS Code windows**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- /home/knatte/Code/millhouse/wts/mill-vscode-spawn-session-leak/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/mill-vscode-spawn-session-leak/_mill/plan/01-scrub-session-env.md
...
- Overview: `/home/knatte/Code/millhouse/wts/mill-vscode-spawn-session-leak/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-vscode-spawn-session-leak/_mill/plan/01-scrub-session-env.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-vscode-spawn-session-leak/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-vscode-spawn-session-leak/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-vscode-spawn-session-leak/_mill/briefs/review-code-holistic-r1.out.md`
