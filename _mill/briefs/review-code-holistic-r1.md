...
You are an independent code reviewer for **millpy-implement.py --stage baseline: WinError 3 snapshotting a transient/generated file on Windows**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- /home/knatte/Code/millhouse/wts/mill-baseline-snapshot-windows-path-gap/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/mill-baseline-snapshot-windows-path-gap/_mill/plan/01-toctou-guard-hardening.md
- /home/knatte/Code/millhouse/wts/mill-baseline-snapshot-windows-path-gap/plugins/mill/scripts/_safe_rmtree.py
- /home/knatte/Code/millhouse/wts/mill-baseline-snapshot-windows-path-gap/plugins/mill/scripts/_junction.py
- /home/knatte/Code/millhouse/wts/mill-baseline-snapshot-windows-path-gap/plugins/mill/unit_tests/test-safe-rmtree.py
- /home/knatte/Code/millhouse/wts/mill-baseline-snapshot-windows-path-gap/plugins/mill/unit_tests/test-junction.py

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-baseline-snapshot-windows-path-gap/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-baseline-snapshot-windows-path-gap/_mill/plan/01-toctou-guard-hardening.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-baseline-snapshot-windows-path-gap/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-baseline-snapshot-windows-path-gap/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-baseline-snapshot-windows-path-gap/_mill/briefs/review-code-holistic-r1.out.md`
