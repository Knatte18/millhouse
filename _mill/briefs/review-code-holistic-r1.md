...
You are an independent code reviewer for **status.md: rename parent to parent_branch, add parent_thread**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/status-parent-fields`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=37)

- _mill/plan/00-overview.md
- _mill/plan/01-status-core.md
- _mill/plan/02-spawn-parent-thread.md
- _mill/plan/03-templates-skills-fixtures.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/status-parent-fields/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/status-parent-fields/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/status-parent-fields/_mill/briefs/review-code-holistic-r1.out.md`
