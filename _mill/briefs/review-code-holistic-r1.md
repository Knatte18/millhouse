...
You are an independent code reviewer for **CLAUDE_PLUGIN_ROOT environment variable not exported to Bash tool**.
...
- /home/knatte/Code/millhouse/wts/claude-plugin-root-env-setup/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/claude-plugin-root-env-setup/_mill/plan/01-plugin-root-resolution.md
- /home/knatte/Code/millhouse/wts/claude-plugin-root-env-setup/plugins/mill/scripts/_config.py
- /home/knatte/Code/millhouse/wts/claude-plugin-root-env-setup/plugins/mill/unit_tests/test-config.py
- /home/knatte/Code/millhouse/wts/claude-plugin-root-env-setup/plugins/mill/skills/mill-setup/SKILL.md
- /home/knatte/Code/millhouse/wts/claude-plugin-root-env-setup/_mill/discussion.md
- /home/knatte/Code/millhouse/wts/claude-plugin-root-env-setup/plugins/mill/scripts/_claude_settings.py

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/claude-plugin-root-env-setup/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/claude-plugin-root-env-setup/_mill/plan/01-plugin-root-resolution.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/claude-plugin-root-env-setup/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/claude-plugin-root-env-setup/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/claude-plugin-root-env-setup/_mill/briefs/review-code-holistic-r1.out.md`
