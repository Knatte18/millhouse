...
You are an independent code reviewer for **mill-merge-in SKILL.md: _plan_dag helper calls missing signature lines**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- /home/knatte/Code/millhouse/wts/mill-merge-in-plan-dag-signature-docs/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/mill-merge-in-plan-dag-signature-docs/_mill/plan/01-add-signature-lines.md
- /home/knatte/Code/millhouse/wts/mill-merge-in-plan-dag-signature-docs/plugins/mill/skills/mill-merge-in/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-merge-in-plan-dag-signature-docs/plugins/mill/scripts/_plan_dag.py
- /home/knatte/Code/millhouse/wts/mill-merge-in-plan-dag-signature-docs/plugins/mill/skills/mill-go/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-merge-in-plan-dag-signature-docs/_mill/discussion.md

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-merge-in-plan-dag-signature-docs/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-merge-in-plan-dag-signature-docs/_mill/plan/01-add-signature-lines.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-merge-in-plan-dag-signature-docs/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-merge-in-plan-dag-signature-docs/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-merge-in-plan-dag-signature-docs/_mill/briefs/review-code-holistic-r1.out.md`
