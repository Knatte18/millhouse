...
You are an independent code reviewer for **Ask the parent session when stuck (parent_thread)**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/parent-thread-escalation`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=34)

- _mill/plan/00-overview.md
- _mill/plan/01-parent-escalation-helper.md
- _mill/plan/02-fixer-parent-guidance.md
- _mill/plan/03-ask-parent-skill.md
- _mill/plan/04-mill-go-base-wiring.md
- _mill/plan/05-plan-start-quick-wiring.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/parent-thread-escalation/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/parent-thread-escalation/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/parent-thread-escalation/_mill/briefs/review-code-holistic-r1.out.md`
