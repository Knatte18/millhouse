...
You are an independent code reviewer for **mill-go/mill-merge-in orchestration robustness gaps, round 2**.
...
Every unprefixed path below is relative to `/home/hanf/Code/millhouse/wts/mill-go-merge-in-orchestration-robustness-r2`.
- `wiki/` paths are relative to `/home/hanf/Code/millhouse/wiki`

## Files included (N=27)

- _mill/plan/00-overview.md
- _mill/plan/01-finalize-completeness-and-baseline-robustness.md
- _mill/plan/02-orchestration-skill-doc-fixes.md
- _mill/plan/03-plan-validate-build-tag-coverage.md
- _mill/plan/04-merge-in-conflict-and-verify-robustness.md
- _mill/plan/05-self-resolve-card-insertion-auto-renumber.md
...
Write your full report to this file: /home/hanf/Code/millhouse/wts/mill-go-merge-in-orchestration-robustness-r2/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/millhouse/wts/mill-go-merge-in-orchestration-robustness-r2/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/millhouse/wts/mill-go-merge-in-orchestration-robustness-r2/_mill/briefs/review-code-holistic-r1.out.md`
