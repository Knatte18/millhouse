...
You are an independent code reviewer for **Skill doc/table accuracy gaps across mill-groom, mill-start/mill-plan, and implementer-brief**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- /home/knatte/Code/millhouse/wts/mill-skill-docs-and-tooling-accuracy/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/mill-skill-docs-and-tooling-accuracy/_mill/plan/01-doc-tooling-fixes.md
- /home/knatte/Code/millhouse/wts/mill-skill-docs-and-tooling-accuracy/plugins/mill/skills/mill-groom/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-skill-docs-and-tooling-accuracy/plugins/mill/skills/mill-go/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-skill-docs-and-tooling-accuracy/plugins/mill/skills/mill-start/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-skill-docs-and-tooling-accuracy/plugins/python/skills/python-build/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-skill-docs-and-tooling-accuracy/CLAUDE.md

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-skill-docs-and-tooling-accuracy/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-skill-docs-and-tooling-accuracy/_mill/plan/01-doc-tooling-fixes.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-skill-docs-and-tooling-accuracy/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-skill-docs-and-tooling-accuracy/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-skill-docs-and-tooling-accuracy/_mill/briefs/review-code-holistic-r1.out.md`
