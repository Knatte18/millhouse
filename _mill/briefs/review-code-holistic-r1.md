...
You are an independent code reviewer for **Fix nested-junction teardown, Windows verify gate in merge-in, and review-plan --round threading**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\mill-junction-and-agent-gaps\_mill\plan\00-overview.md
...
- C:\Code\millhouse\wts\mill-junction-and-agent-gaps\plugins\mill\scripts\_worktree.py
- C:\Code\millhouse\wts\mill-junction-and-agent-gaps\plugins\mill\scripts\_junction.py
- C:\Code\millhouse\wts\mill-junction-and-agent-gaps\plugins\mill\unit_tests\test-junction.py
- C:\Code\millhouse\wts\mill-junction-and-agent-gaps\plugins\mill\scripts\_implementer_common.py
- C:\Code\millhouse\wts\mill-junction-and-agent-gaps\plugins\mill\scripts\millpy-merge-in-subagent.py
- C:\Code\millhouse\wts\mill-junction-and-agent-gaps\plugins\mill\unit_tests\test-millpy-merge-in-subagent.py
- C:\Code\millhouse\wts\mill-junction-and-agent-gaps\plugins\mill\unit_tests\test-merge-in-subagent.py
- C:\Code\millhouse\wts\mill-junction-and-agent-gaps\plugins\mill\scripts\_review_common.py
- C:\Code\millhouse\wts\mill-junction-and-agent-gaps\plugins\mill\scripts\millpy-review-plan.py
- C:\Code\millhouse\wts\mill-junction-and-agent-gaps\plugins\mill\scripts\millpy-review-discussion.py
- C:\Code\millhouse\wts\mill-junction-and-agent-gaps\plugins\mill\unit_tests\test-review-plan-finalize-round.py

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\mill-junction-and-agent-gaps\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\mill-junction-and-agent-gaps\_mill\plan\01-junction-recursive-walk.md`
  - `C:\Code\millhouse\wts\mill-junction-and-agent-gaps\_mill\plan\02-posix-shell-helper.md`
  - `C:\Code\millhouse\wts\mill-junction-and-agent-gaps\_mill\plan\03-review-round-autodiscovery.md`
