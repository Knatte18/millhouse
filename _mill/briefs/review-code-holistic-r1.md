...
You are an independent code reviewer for **Fix mill-start instruction gaps, baseline long-path on Windows, and language skill tooling reliability**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\_mill\plan\00-overview.md
...
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\mill\scripts\_marker.py
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\mill\scripts\_paths.py
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\mill\skills\mill-start\SKILL.md
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\mill\skills\mill-plan\SKILL.md
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\mill\skills\mill-receiving-review\SKILL.md
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\mill\scripts\_subprocess_util.py
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\mill\scripts\_verify_baseline.py
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\mill\unit_tests\test-worktree.py
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\mill\unit_tests\test-verify-baseline.py
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\mill\skills\workflow\SKILL.md
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\csharp\skills\csharp-build\SKILL.md
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\CLAUDE.md
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\golang\skills\golang-build\SKILL.md
- C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\plugins\mill\skills\git-commit\SKILL.md

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\_mill\plan\01-mill-skill-entry-and-note.md`
  - `C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\_mill\plan\02-baseline-longpath.md`
  - `C:\Code\millhouse\wts\mill-start-and-baseline-tooling-gaps\_mill\plan\03-dotnet-noise.md`
