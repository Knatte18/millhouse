...
You are an independent code reviewer for **mill-go: concurrency, silently-ignored fields, and bookkeeping bugs in execution/handoff**.
...
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/_mill/plan/01-mill-go-base-doc-fixes.md
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/_mill/plan/02-mill-go-base-scope-and-numbering-fixes.md
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/_mill/plan/03-mill-descope-batch.md
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/skills/mill-go-base/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/scripts/_plan_validate.py
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/unit_tests/test-plan-validate-card-numbering.py
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/skills/mill-go-base/holistic-review.md
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/scripts/_status.py
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/unit_tests/test-status.py
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/scripts/_plan_dag.py
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/unit_tests/test-plan-dag.py
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/SKILLS.md
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/scripts/millpy-descope-batch.py
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/skills/mill-descope-batch/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/scripts/_implementer_common.py
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/skills/mill-go-base/handoff.md
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/scripts/millpy-abandon.py
- /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/plugins/mill/skills/mill-abandon/SKILL.md

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/_mill/plan/01-mill-go-base-doc-fixes.md`
  - `/home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/_mill/plan/02-mill-go-base-scope-and-numbering-fixes.md`
  - `/home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/_mill/plan/03-mill-descope-batch.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-go-execution-and-bookkeeping-bugs/_mill/briefs/review-code-holistic-r1.out.md`
