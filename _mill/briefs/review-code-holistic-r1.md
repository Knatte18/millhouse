...
You are an independent code reviewer for **code-comments skill: prohibit enumerating current consumers/writers of a shared resource**.
...
- /home/knatte/Code/millhouse/wts/code-comments-skill-consumer-enumeration-rule/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/code-comments-skill-consumer-enumeration-rule/_mill/plan/01-enumerated-consumer-rule.md
- /home/knatte/Code/millhouse/wts/code-comments-skill-consumer-enumeration-rule/plugins/mill/skills/code-comments/SKILL.md
- /home/knatte/Code/millhouse/wts/code-comments-skill-consumer-enumeration-rule/plugins/mill/skills/markdown/SKILL.md
- /home/knatte/Code/millhouse/wts/code-comments-skill-consumer-enumeration-rule/_mill/discussion.md

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/code-comments-skill-consumer-enumeration-rule/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/code-comments-skill-consumer-enumeration-rule/_mill/plan/01-enumerated-consumer-rule.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/code-comments-skill-consumer-enumeration-rule/_mill/briefs/review-code-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/code-comments-skill-consumer-enumeration-rule/_mill/briefs/review-code-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/code-comments-skill-consumer-enumeration-rule/_mill/briefs/review-code-holistic-r1.out.md`
