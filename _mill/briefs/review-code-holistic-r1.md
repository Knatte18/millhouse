...
You are an independent code reviewer for **Fix nested-hub-layout path resolution bugs across scope violations and review CLIs**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\scripts\_cleanliness.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\scripts\_implementer_common.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\skills\mill-go\SKILL.md
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\unit_tests\test-cleanliness.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\scripts\millpy-review-plan.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\scripts\millpy-review-code.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\unit_tests\test-review-plan-flow.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\unit_tests\test-review-code-flow.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\scripts\_plan_dag.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\unit_tests\test-plan-dag.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\scripts\_verify_baseline.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\scripts\millpy-implement.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\unit_tests\test-implementer-common.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\unit_tests\test-millpy-implement.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\scripts\millpy-fix.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\unit_tests\test-millpy-fix.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\unit_tests\test-fix-finalize.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\scripts\_plan_validate.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\unit_tests\test-plan-validate.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\skills\mill-merge-in\SKILL.md
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\integration_tests\test-merge.py
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\skills\mill-plan\SKILL.md
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\templates\plan-batch.md
- C:\Code\millhouse\wts\nested-layout-fixes\plugins\mill\templates\plan-overview.md

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\nested-layout-fixes\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\nested-layout-fixes\_mill\plan\01-scope-violation-rebase.md`
  - `C:\Code\millhouse\wts\nested-layout-fixes\_mill\plan\02-brief-path-fix.md`
  - `C:\Code\millhouse\wts\nested-layout-fixes\_mill\plan\03-verify-cwd-foundation.md`
