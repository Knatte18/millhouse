...
You are an independent plan reviewer for **Non-interactive pipeline: only mill-start's interview may prompt the operator**. You evaluate the complete plan (all batches) and produce a structured review.
...
- /home/knatte/Code/millhouse/wts/pipeline-walkaway-mode/plugins/mill/scripts/_autonomous.py
- /home/knatte/Code/millhouse/wts/pipeline-walkaway-mode/plugins/mill/unit_tests/test-autonomous.py
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/pipeline-walkaway-mode/_mill/briefs/review-plan-holistic-r4.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/pipeline-walkaway-mode/_mill/briefs/review-plan-holistic-r4.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/pipeline-walkaway-mode/_mill/briefs/review-plan-holistic-r4.out.md`
