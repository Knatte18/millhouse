...
You are an independent plan reviewer for **_plan_validate context-completeness: further false-positive/false-negative gaps, round 3**.
...
Every unprefixed path below is relative to `/home/hanf/Code/millhouse/wts/plan-validate-context-completeness-round3-gaps`.
- `wiki/` paths are relative to `/home/hanf/Code/millhouse/wiki`

## Files included (N=6)

- _mill/plan/00-overview.md
- _mill/plan/01-context-completeness-resolution-and-tokenization-rework.md
...
Write your full report to this file: /home/hanf/Code/millhouse/wts/plan-validate-context-completeness-round3-gaps/_mill/briefs/review-plan-holistic-r6.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/millhouse/wts/plan-validate-context-completeness-round3-gaps/_mill/briefs/review-plan-holistic-r6.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/millhouse/wts/plan-validate-context-completeness-round3-gaps/_mill/briefs/review-plan-holistic-r6.out.md`
