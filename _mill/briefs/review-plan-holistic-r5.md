...
You are an independent plan reviewer for **mill-go-base: orchestration robustness gaps**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/mill-go-base-orchestration-robustness-gaps`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=18)

- _mill/plan/00-overview.md
- _mill/plan/01-status-helpers-core.md
- _mill/plan/02-status-helpers-baseline.md
- _mill/plan/03-entry-gate-parallel-baseline.md
- _mill/plan/04-blocked-batch-resume.md
- _mill/plan/05-review-loop-fixes.md
- _mill/plan/06-agent-dispatch-liveness.md
- _mill/plan/07-handoff-worktree-guard.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-go-base-orchestration-robustness-gaps/_mill/briefs/review-plan-holistic-r5.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-go-base-orchestration-robustness-gaps/_mill/briefs/review-plan-holistic-r5.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-go-base-orchestration-robustness-gaps/_mill/briefs/review-plan-holistic-r5.out.md`
