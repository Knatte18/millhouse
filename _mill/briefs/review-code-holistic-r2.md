...
You are an independent code reviewer for **Fix review finding-count parser, nested-layout brief path, verify cwd, process leaks, and missing done-gate**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\_mill\plan\00-overview.md
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\_mill\plan\01-parser-and-brief.md
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\_mill\plan\02-implementer-cwd-and-dotnet.md
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\_mill\plan\03-done-gate.md
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\scripts\_review_common.py
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\unit_tests\test-review-common.py
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\scripts\_paths.py
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\scripts\millpy-review-discussion.py
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\unit_tests\test-review-discussion-flow.py
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\scripts\_implementer_common.py
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\scripts\millpy-implement.py
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\scripts\millpy-fix.py
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\unit_tests\test-implementer-common.py
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\templates\mill-config.yaml
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\skills\mill-go\SKILL.md
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\skills\mill-plan\SKILL.md
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\scripts\_config.py
- C:\Code\millhouse\wts\mill-verify-and-layout-gaps\plugins\mill\unit_tests\test-config.py

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\mill-verify-and-layout-gaps\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\mill-verify-and-layout-gaps\_mill\plan\01-parser-and-brief.md`
  - `C:\Code\millhouse\wts\mill-verify-and-layout-gaps\_mill\plan\02-implementer-cwd-and-dotnet.md`
  - `C:\Code\millhouse\wts\mill-verify-and-layout-gaps\_mill\plan\03-done-gate.md`
