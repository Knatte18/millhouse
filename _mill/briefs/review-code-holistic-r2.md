...
You are an independent code reviewer for **Misc infra/wiki/PR/self-hosting reliability bugs**.
...
- Card 17's own verification method would not have caught the doubling: Location: _mill/plan/08-skill-cross-reference-fix.md:59-62. Issue: the batch's stated self-check is satisfied even by the doubled/malformed form found above, since a doubled prefix still "starts with" the expected prefix -- the check as written cannot distinguish correct-once from correct-twice.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=55)

- _mill/plan/00-overview.md
- _mill/plan/01-wiki-daemon-reliability.md
- _mill/plan/02-pr-state-and-cache-freshness.md
- _mill/plan/03-merge-in-verify-field-fix.md
- _mill/plan/04-baseline-lazy-preflight.md
- _mill/plan/05-review-duration-derivation.md
- _mill/plan/06-handoff-skill-doc-fix.md
- _mill/plan/07-csharp-build-node-reuse.md
- _mill/plan/08-skill-cross-reference-fix.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/briefs/review-code-holistic-r2.out.md`
