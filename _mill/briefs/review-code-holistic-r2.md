...
You are an independent code reviewer for **Add first-class Moves/Renames field to plan cards for rename-heavy batches**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- `_RE_MECHANIC_HEADING` defined as a local variable inside function body: **Location:** `C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\scripts\_plan_validate.py:577`
...
- C:\Code\millhouse\wts\mill-plan-rename-moves\_mill\plan\00-overview.md
- C:\Code\millhouse\wts\mill-plan-rename-moves\_mill\plan\01-move-parsing-foundation.md
- C:\Code\millhouse\wts\mill-plan-rename-moves\_mill\plan\02-validator-move-checks.md
- C:\Code\millhouse\wts\mill-plan-rename-moves\_mill\plan\03-templates-skill-config.md
- C:\Code\millhouse\wts\mill-plan-rename-moves\_mill\plan\04-review-backends.md
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\scripts\_plan_validate.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\scripts\_review_common.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\unit_tests\test-review-common.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\templates\plan-batch.md
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\unit_tests\test-plan-validate.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\unit_tests\test-millpy-validate-plan.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\templates\review-plan-batch.md
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\templates\review-plan-holistic.md
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\templates\review-code-batch.md
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\skills\mill-plan\SKILL.md
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\scripts\_review_code.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\templates\mill-config.yaml
- C:\Code\millhouse\wts\mill-plan-rename-moves\mill-config.yaml
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\unit_tests\test-config.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\scripts\_review_plan.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\unit_tests\test-review-plan-flow.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\unit_tests\test-review-code-flow.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\scripts\_moves_check.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\unit_tests\test-moves-check.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\scripts\_status.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\scripts\_agent_dispatch.py
- C:\Code\millhouse\wts\mill-plan-rename-moves\plugins\mill\unit_tests\test-language-skills-directive.py

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\mill-plan-rename-moves\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\mill-plan-rename-moves\_mill\plan\01-move-parsing-foundation.md`
  - `C:\Code\millhouse\wts\mill-plan-rename-moves\_mill\plan\02-validator-move-checks.md`
  - `C:\Code\millhouse\wts\mill-plan-rename-moves\_mill\plan\03-templates-skill-config.md`
