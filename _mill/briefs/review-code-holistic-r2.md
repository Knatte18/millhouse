...
You are an independent code reviewer for **millpy-implement/fix.py: stuck-type false positives and session-hygiene gaps**.
...
- CLI-to-finalize git identity wiring has no regression test: **Location:** `plugins/mill/unit_tests/test-millpy-implement.py`, `plugins/mill/unit_tests/test-fix-finalize.py`
...
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/plan/01-commit-baseline-write-before-dirty-check.md
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/plan/02-test-corroboration-write-commit.md
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/plan/03-forward-verify-baselines-millpy-fix.md
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/plan/04-fresh-session-after-self-resolve.md
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/plan/05-bg-heartbeat-diagnosability.md
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/plugins/mill/scripts/_implementer_common.py
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/plugins/mill/scripts/millpy-implement.py
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/plugins/mill/scripts/millpy-fix.py
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/plugins/mill/unit_tests/test-implementer-common.py
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/plugins/mill/unit_tests/test-fix-finalize.py
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/plugins/mill/scripts/_status.py
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/plugins/mill/unit_tests/test-status.py
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/plugins/mill/unit_tests/test-millpy-implement.py
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/plugins/mill/scripts/millpy-bg.py
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/plugins/mill/unit_tests/test-millpy-bg.py
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/plugins/mill/scripts/_subprocess_util.py
- /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/plugins/mill/scripts/_plan_dag.py

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/plan/01-commit-baseline-write-before-dirty-check.md`
  - `/home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/plan/02-test-corroboration-write-commit.md`
  - `/home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/plan/03-forward-verify-baselines-millpy-fix.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/millpy-implement-fix-stuck-type-false-positives/_mill/briefs/review-code-holistic-r2.out.md`
