...
You are an independent code reviewer for **mill-plan: Requirements find/replace fences lose byte-exactness under list-nested indentation**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- CRLF test doesn't isolate the explicit normalization step: **Location:** `plugins/mill/scripts/_plan_validate.py:1783` and `plugins/mill/unit_tests/test-plan-validate.py:2311-2350`
...
- /home/knatte/Code/millhouse/wts/mill-plan-requirements-byte-exactness-gap/_mill/plan/00-overview.md
...
- /home/knatte/Code/millhouse/wts/mill-plan-requirements-byte-exactness-gap/plugins/mill/scripts/_plan_validate.py
- /home/knatte/Code/millhouse/wts/mill-plan-requirements-byte-exactness-gap/plugins/mill/skills/mill-plan/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-plan-requirements-byte-exactness-gap/plugins/mill/unit_tests/test-plan-validate.py
- /home/knatte/Code/millhouse/wts/mill-plan-requirements-byte-exactness-gap/_mill/discussion.md

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-plan-requirements-byte-exactness-gap/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-plan-requirements-byte-exactness-gap/_mill/plan/01-requirements-quote-indent-drift-check.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-plan-requirements-byte-exactness-gap/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-plan-requirements-byte-exactness-gap/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-plan-requirements-byte-exactness-gap/_mill/briefs/review-code-holistic-r2.out.md`
