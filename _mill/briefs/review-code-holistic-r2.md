...
You are an independent code reviewer for **Batch verify/baseline/completeness gates produce false positives or time out**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- Hub's own mill-config.yaml documents a `done_gate` key that isn't present: **Location:** `mill-config.yaml:20`
- Same-directory removed-tag transitions with differing tag values silently pick one: **Location:** `plugins/mill/scripts/_implementer_common.py:1039-1042`
- `_done_gate.run_preflight` only guards `OSError`, narrower than the "never raise" wording: **Location:** `plugins/mill/scripts/_done_gate.py:71-79`
...
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/plan/00-overview.md
...
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/plan/02-go-build-tag-retiering-check.md
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/plan/03-batch-verify-list-validation.md
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/plan/04-done-gate-baseline-preflight.md
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/plan/05-finalize-timeout-guidance-generalization.md
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/plan/06-windows-long-path-mitigation.md
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/scripts/_plan_dag.py
...
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/scripts/_subprocess_util.py
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/scripts/_plan_validate.py
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/scripts/_parent_branch.py
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/scripts/_paths.py
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/scripts/millpy-review-plan.py
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/skills/mill-plan/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/unit_tests/test-plan-validate.py
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/skills/mill-go/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/scripts/_done_gate.py
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/templates/mill-config.yaml
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/mill-config.yaml
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/unit_tests/test-verify-baseline.py
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/unit_tests/test-done-gate.py
- /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/plugins/mill/scripts/_verify_baseline.py

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/plan/01-completeness-recount-cards-done.md`
  - `/home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/plan/02-go-build-tag-retiering-check.md`
  - `/home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/plan/03-batch-verify-list-validation.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-go-batch-verify-baseline-reliability/_mill/briefs/review-code-holistic-r2.out.md`
