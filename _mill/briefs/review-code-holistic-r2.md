...
You are an independent code reviewer for **mill-go's one-shot pre-batch-1 baseline can't cover a task's own later per-batch-baseline capability**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- `is_self_hosting_task` omitted from `_paths.py`'s `__all__` and module-docstring "Public API" index: Location: `plugins/mill/scripts/_paths.py:110-131` (`__all__`), `:9-99` (module docstring "Public API:" list)
...
- /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/_mill/plan/00-overview.md
...
- /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/plugins/mill/scripts/_paths.py
- /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/plugins/mill/unit_tests/test-paths.py
- /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/plugins/mill/skills/mill-go/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/plugins/mill/scripts/millpy-implement.py
- /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/plugins/mill/scripts/_status.py
- /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/plugins/mill/scripts/_plan_dag.py
- /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/CLAUDE.md

## Plan + source files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/_mill/plan/00-overview.md`
- Batch file(s):
  - `/home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/_mill/plan/01-self-hosting-detection-helper.md`
  - `/home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/_mill/plan/02-per-batch-baseline-recapture-hook.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/_mill/briefs/review-code-holistic-r2.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/_mill/briefs/review-code-holistic-r2.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/_mill/briefs/review-code-holistic-r2.out.md`
