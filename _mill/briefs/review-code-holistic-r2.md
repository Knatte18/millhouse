...
You are an independent code reviewer for **Fix nested mill layout paths, whole-repo formatter drift, and stacked-branch PR cleanup**. You evaluate the complete implementation (every batch) against the approved plan and produce a structured review.
...
- C:\Code\millhouse\wts\mill-external-repo-infra\_mill\plan\00-overview.md
- C:\Code\millhouse\wts\mill-external-repo-infra\_mill\plan\01-path-resolution-scripts.md
- C:\Code\millhouse\wts\mill-external-repo-infra\_mill\plan\02-cleanliness-drift-guard.md
- C:\Code\millhouse\wts\mill-external-repo-infra\_mill\plan\03-orchestrator-skills.md
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\scripts\_paths.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\scripts\_review_common.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\scripts\millpy-review-discussion.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\scripts\millpy-review-plan.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\scripts\millpy-spawn.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\unit_tests\test-paths.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\scripts\_pygit2_util.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\scripts\_subprocess_util.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\scripts\_cleanliness.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\unit_tests\test-cleanliness.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\skills\git-commit\SKILL.md
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\golang\skills\golang-build\SKILL.md
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\python\skills\python-build\SKILL.md
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\csharp\skills\csharp-build\SKILL.md
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\skills\mill-start\SKILL.md
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\skills\mill-plan\SKILL.md
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\scripts\_parent_branch.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\skills\mill-go\SKILL.md
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\skills\git-pr\SKILL.md
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\scripts\_finalize_cleanup.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\skills\mill-finalize\SKILL.md
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\unit_tests\test-finalize-cleanup.py
- C:\Code\millhouse\wts\mill-external-repo-infra\plugins\mill\unit_tests\test-mill-finalize-dispatch.py

## Plan + source files to review
- Overview: `C:\Code\millhouse\wts\mill-external-repo-infra\_mill\plan\00-overview.md`
- Batch file(s):
  - `C:\Code\millhouse\wts\mill-external-repo-infra\_mill\plan\01-path-resolution-scripts.md`
  - `C:\Code\millhouse\wts\mill-external-repo-infra\_mill\plan\02-cleanliness-drift-guard.md`
  - `C:\Code\millhouse\wts\mill-external-repo-infra\_mill\plan\03-orchestrator-skills.md`
