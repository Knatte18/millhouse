...
Stage the deletion with `git -C /home/knatte/Code/millhouse/wts/mill-go2-fork-dispatch-reliability rm <file>`.
...
### From _mill/plan/01-fork-dispatch-reliability-fixes.md
...
5. Run `git -C /home/knatte/Code/millhouse/wts/mill-go2-fork-dispatch-reliability add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/millhouse/wts/mill-go2-fork-dispatch-reliability rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/millhouse/wts/mill-go2-fork-dispatch-reliability` for any git commands;
do not `cd`.
