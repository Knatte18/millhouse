...
Stage the deletion with `git -C /home/knatte/Code/millhouse/wts/mill-go2-scaffold rm <file>`.
...
### From _mill/plan/01-extract-base.md
...
### From _mill/plan/02-thin-variants.md
...
### From _mill/plan/03-repoint-refs.md
...
5. Run `git -C /home/knatte/Code/millhouse/wts/mill-go2-scaffold add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/millhouse/wts/mill-go2-scaffold rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/millhouse/wts/mill-go2-scaffold` for any git commands;
do not `cd`.
Worktree cwd is `/home/knatte/Code/millhouse/wts/mill-go2-scaffold`.
