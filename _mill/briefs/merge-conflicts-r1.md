...
Stage the deletion with `git -C /home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2 rm <file>`.
...
### From _mill/plan/01-wiki-daemon-reliability.md
...
### From _mill/plan/02-pr-state-and-cache-freshness.md
...
### From _mill/plan/03-merge-in-verify-field-fix.md
...
### From _mill/plan/04-baseline-lazy-preflight.md
...
### From _mill/plan/05-review-duration-derivation.md
...
### From _mill/plan/06-handoff-skill-doc-fix.md
...
### From _mill/plan/07-csharp-build-node-reuse.md
...
### From _mill/plan/08-skill-cross-reference-fix.md
...
5. Run `git -C /home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2 add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2 rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2` for any git commands;
do not `cd`.
Worktree cwd is `/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2`.
