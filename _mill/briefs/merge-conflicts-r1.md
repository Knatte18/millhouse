...
Stage the deletion with `git -C /home/knatte/Code/millhouse/wts/mill-go2-fork-fixer rm <file>`.
...
### From _mill/plan/01-status-fork-fallback-log.md
...
### From _mill/plan/02-mill-go2-fixer-override.md
...
5. Run `git -C /home/knatte/Code/millhouse/wts/mill-go2-fork-fixer add <file>` to stage the resolved file.
6. For modify/delete (DU) conflicts: if Task intent above lists this file under a batch's `Deletes:`, run `git -C /home/knatte/Code/millhouse/wts/mill-go2-fork-fixer rm <file>` instead of editing;
...
Use `git -C /home/knatte/Code/millhouse/wts/mill-go2-fork-fixer` for any git commands;
do not `cd`.
Worktree cwd is `/home/knatte/Code/millhouse/wts/mill-go2-fork-fixer`.
