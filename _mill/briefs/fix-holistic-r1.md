...
- **Holistic review file:** `C:\Code\millhouse\wts\mill-review-and-verify-quality\_mill\reviews\20260623-094841-code-review-r1.md`
...
Load the **mill-receiving-review** skill before reading any finding in `C:\Code\millhouse\wts\mill-review-and-verify-quality\_mill\reviews\20260623-094841-code-review-r1.md`. This is non-negotiable.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"588061c4-b112-402d-b520-88c92e4cb86a"}
```
...
**`session_id` MUST be exactly `588061c4-b112-402d-b520-88c92e4cb86a` (the UUID shown in the example above — it was injected into this brief when it was rendered). Copy it verbatim.**

or, when stuck:

```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"588061c4-b112-402d-b520-88c92e4cb86a"}
```
**Do not wrap the JSON in a code block. Output it as a bare line — no backticks, no fence. Anything other than a bare JSON line is treated as `stuck_type: logic`.**
