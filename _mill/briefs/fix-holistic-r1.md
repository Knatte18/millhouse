# Holistic Fixer Brief — Misc infra/wiki/PR/self-hosting reliability bugs
...
- **Holistic review file:** `/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/reviews/20260921-170027-code-review-r1.md`
- **Plan overview:** `/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/plan/00-overview.md`
- **Worktree cwd (use for git and verify):** `/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2`
...
```
/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/plan/01-wiki-daemon-reliability.md
/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/plan/02-pr-state-and-cache-freshness.md
/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/plan/03-merge-in-verify-field-fix.md
/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/plan/04-baseline-lazy-preflight.md
/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/plan/05-review-duration-derivation.md
/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/plan/06-handoff-skill-doc-fix.md
/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/plan/07-csharp-build-node-reuse.md
/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/plan/08-skill-cross-reference-fix.md
```

## Before reading any finding

Load the **mill-receiving-review** skill before reading any finding in `/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2/_mill/reviews/20260921-170027-code-review-r1.md`.
...
Run each from `/home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2` via Bash.
...
**Pre-report self-check (mandatory before emitting success JSON):** At the very start of your session (before any edit), record `git -C /home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2 rev-parse HEAD` as your baseline -- this is the holistic fix housekeeping commit (message starts with `mill-go: holistic fix`).
Before reporting `success`, confirm HEAD now differs from that recorded baseline;
never report `success` when HEAD equals the baseline (no new commit was made). Run `git -C /home/knatte/Code/millhouse/wts/mill-infra-reliability-misc-r2 status --porcelain --untracked-files=no`.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"c508be6f-2d59-46e2-b29d-1f61f42904ff"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**

**`session_id` MUST be exactly `c508be6f-2d59-46e2-b29d-1f61f42904ff` (the UUID shown in the example above — it was injected into this brief when it was rendered).
Copy it verbatim.**
...
```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"c508be6f-2d59-46e2-b29d-1f61f42904ff"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**
