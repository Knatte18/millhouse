...
- **Holistic review file:** `/home/hanf/Code/millhouse/wts/plan-validate-context-completeness-round3-gaps/_mill/reviews/20260923-130739-code-review-r1.md`
...
Load the **mill-receiving-review** skill before reading any finding in `/home/hanf/Code/millhouse/wts/plan-validate-context-completeness-round3-gaps/_mill/reviews/20260923-130739-code-review-r1.md`.
...
never report `success` when HEAD equals the baseline (no new commit was made). Run `git -C /home/hanf/Code/millhouse/wts/plan-validate-context-completeness-round3-gaps status --porcelain --untracked-files=no`.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"73d18d1a-304c-48b0-99d3-a5f8431cd624"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**

**`session_id` MUST be exactly `73d18d1a-304c-48b0-99d3-a5f8431cd624` (the UUID shown in the example above — it was injected into this brief when it was rendered).
Copy it verbatim.**
...
```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"73d18d1a-304c-48b0-99d3-a5f8431cd624"}
```
**Do not wrap the JSON in a code block.
Output it as a bare line — no backticks, no fence.
Anything other than a bare JSON line is treated as `stuck_type: logic`.**
