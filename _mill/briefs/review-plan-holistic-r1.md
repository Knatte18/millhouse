...
You are an independent plan reviewer for **mill-plan SKILL.md: step 6 max-rounds escape bugs, self-run validator citation errors, and Step 1.5 fix-table wrong remedies**.
...
- /home/knatte/Code/millhouse/wts/mill-plan-step6-and-fixtable-bugs/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/mill-plan-step6-and-fixtable-bugs/_mill/plan/01-skillmd-blocked-resume-and-fixtable-fixes.md
- /home/knatte/Code/millhouse/wts/mill-plan-step6-and-fixtable-bugs/plugins/mill/skills/mill-plan/SKILL.md

## Plan files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-plan-step6-and-fixtable-bugs/_mill/plan/00-overview.md`
- Batches:
- `/home/knatte/Code/millhouse/wts/mill-plan-step6-and-fixtable-bugs/_mill/plan/01-skillmd-blocked-resume-and-fixtable-fixes.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-plan-step6-and-fixtable-bugs/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-plan-step6-and-fixtable-bugs/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-plan-step6-and-fixtable-bugs/_mill/briefs/review-plan-holistic-r1.out.md`
