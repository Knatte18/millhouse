...
You are an independent plan reviewer for **Fix daemon health-check race, finalize env-var delivery, skills-index drop, and encoding crash**. You evaluate the complete plan (all batches) and produce a structured review.
