...
You are an independent plan reviewer for **_plan_validate.py verify: command validation: false positives, missing escape hatches, and a doc/enforcement mismatch**.
...
- /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/_mill/plan/00-overview.md
...
- /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/plugins/mill/scripts/_plan_validate.py
- /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/plugins/mill/scripts/millpy-review-plan.py
- /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/plugins/mill/scripts/millpy-validate-plan.py
- /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/plugins/mill/unit_tests/test-plan-validate.py
- /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/plugins/mill/skills/mill-plan/SKILL.md
- /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/plugins/mill/templates/review-plan-holistic.md
- /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/plugins/mill/templates/mill-config.yaml
- /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/plugins/mill/scripts/_plan_validate.py
- /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/CLAUDE.md

## Plan files to review
- Overview: `/home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/_mill/plan/00-overview.md`
- Batches:
- `/home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/_mill/plan/01-verify-full-suite-check-fixes.md`
- `/home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/_mill/plan/02-verify-full-suite-unit-tests.md`
- `/home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/_mill/plan/03-docs-and-reviewer-guardrail.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/plan-validate-verify-command-validation-bugs/_mill/briefs/review-plan-holistic-r1.out.md`
