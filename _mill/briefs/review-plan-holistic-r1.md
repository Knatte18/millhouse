...
You are an independent plan reviewer for **Fix nit-enforcement gate marker gaps, NIT-dispatch wording, implementer liveness probe, and Haiku false-completion**. You evaluate the complete plan (all batches) and produce a structured review.
...
- C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\_mill\plan\00-overview.md
- C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\_mill\plan\01-nits-only-envelope-threading.md
- C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\_mill\plan\02-mill-go-skill-prose-fixes.md
- C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\_mill\plan\03-implementer-brief-and-config-hardening.md
- C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\plugins\mill\scripts\_implementer_common.py
- C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\plugins\mill\unit_tests\test-implementer-common.py
- C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\plugins\mill\scripts\millpy-fix.py
- C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\plugins\mill\unit_tests\test-millpy-fix.py
- C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\plugins\mill\skills\mill-go\SKILL.md
- C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\plugins\mill\templates\implementer-brief.md
- C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\plugins\mill\templates\mill-config.yaml
- C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\plugins\mill\unit_tests\test-config.py

## Plan files to review
- Overview: `C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\_mill\plan\00-overview.md`
- Batches:
- `C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\_mill\plan\01-nits-only-envelope-threading.md`
- `C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\_mill\plan\02-mill-go-skill-prose-fixes.md`
- `C:\Code\millhouse\wts\mill-go-nit-gate-and-dispatch-gaps\_mill\plan\03-implementer-brief-and-config-hardening.md`
