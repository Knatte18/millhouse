...
You are an independent plan reviewer for **Deactivate codeguide integration in millhouse**.
...
Every unprefixed path below is relative to `/home/hanf/Code/millhouse/wts/deactivate-codeguide`.
- `wiki/` paths are relative to `/home/hanf/Code/millhouse/wiki`

## Files included (N=18)

- _mill/plan/00-overview.md
- _mill/plan/01-deactivate-call-sites.md
- _mill/plan/02-prose-cleanup.md
- _mill/plan/03-close-issue.md
...
Write your full report to this file: /home/hanf/Code/millhouse/wts/deactivate-codeguide/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/millhouse/wts/deactivate-codeguide/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/millhouse/wts/deactivate-codeguide/_mill/briefs/review-plan-holistic-r1.out.md`
