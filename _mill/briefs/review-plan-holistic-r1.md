...
You are an independent plan reviewer for **Track _mill/briefs/ instead of gitignoring them**. You evaluate the complete plan (all batches) and produce a structured review.
...
## Plan content (overview + all batches + referenced files + cross-batch ancestor creates)
