...
You are an independent plan reviewer for **Fix stale checkpoint safety, Go binary ephemeral allowlist, and bare agent-tier name trap**. You evaluate the complete plan (all batches) and produce a structured review.
