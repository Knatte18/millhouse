...
You are an independent plan reviewer for **Fix agent-pipeline reliability gaps in finalize/success contract**. You evaluate the complete plan (all batches) and produce a structured review.
