...
You are an independent plan reviewer for **Fix millpy-review-discussion to write briefs to the task worktree**. You evaluate the complete plan (all batches) and produce a structured review.
