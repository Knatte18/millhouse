...
You are an independent plan reviewer for **Fix plan validator Moves-target gap, code-review backtick parser, and mill-start encoding crash**. You evaluate the complete plan (all batches) and produce a structured review.
