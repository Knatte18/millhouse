...
You are an independent plan reviewer for **mill-go's one-shot pre-batch-1 baseline can't cover a task's own later per-batch-baseline capability**. You evaluate the complete plan (all batches) and produce a structured review.
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-go-per-batch-baseline-preflight-gap/_mill/briefs/review-plan-holistic-r1.out.md`
