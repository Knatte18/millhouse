...
You are an independent plan reviewer for **_config.py / _treeguard.py: silently-ignored config keys and unguarded str-vs-Path args**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/shared-helper-script-validation-gaps`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=7)

- _mill/plan/00-overview.md
- _mill/plan/01-config-treeguard-guards.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/shared-helper-script-validation-gaps/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/shared-helper-script-validation-gaps/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/shared-helper-script-validation-gaps/_mill/briefs/review-plan-holistic-r1.out.md`
