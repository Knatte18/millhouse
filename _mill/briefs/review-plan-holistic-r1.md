...
You are an independent plan reviewer for **Fix prepare-retry atomicity, partial-batch finalize routing, and envelope field parity**. You evaluate the complete plan (all batches) and produce a structured review.
