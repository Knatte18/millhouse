...
You are an independent plan reviewer for **Add Go skill package (build, test, comments)**. You evaluate the complete plan (all batches) and produce a structured review.
