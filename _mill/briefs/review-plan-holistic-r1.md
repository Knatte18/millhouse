...
You are an independent plan reviewer for **mill-merge: run the deterministic path as one script**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/mill-merge-script`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=29)

- _mill/plan/00-overview.md
- _mill/plan/01-merge-core-entry.md
- _mill/plan/02-merge-core-squash.md
- _mill/plan/03-merge-cli.md
- _mill/plan/04-skill-rewrite.md
- _mill/plan/05-cross-references.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-merge-script/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-merge-script/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-merge-script/_mill/briefs/review-plan-holistic-r1.out.md`
