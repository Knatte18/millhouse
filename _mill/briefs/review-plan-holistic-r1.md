...
You are an independent plan reviewer for **Unify ask-parent into ask-thread: ask any named session, default parent**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/ask-thread-skill`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=22)

- _mill/plan/00-overview.md
- _mill/plan/01-ask-thread-scripts.md
- _mill/plan/02-ask-thread-skill-and-callers.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/ask-thread-skill/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/ask-thread-skill/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/ask-thread-skill/_mill/briefs/review-plan-holistic-r1.out.md`
