...
You are an independent plan reviewer for **Add first-class Moves/Renames field to plan cards for rename-heavy batches**. You evaluate the complete plan (all batches) and produce a structured review.
