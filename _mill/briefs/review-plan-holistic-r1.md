...
You are an independent plan reviewer for **mill-plan/verify/implement pipeline: misc small bugs, round 3**.
...
Every unprefixed path below is relative to `/home/hanf/Code/millhouse/wts/mill-plan-verify-implement-misc-r3`.
- `wiki/` paths are relative to `/home/hanf/Code/millhouse/wiki`

## Files included (N=21)

- _mill/plan/00-overview.md
- _mill/plan/01-plan-validate-dotnet-scoping.md
- _mill/plan/02-status-path-coercion.md
- _mill/plan/03-verify-guidance-docs.md
...
Write your full report to this file: /home/hanf/Code/millhouse/wts/mill-plan-verify-implement-misc-r3/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/millhouse/wts/mill-plan-verify-implement-misc-r3/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/millhouse/wts/mill-plan-verify-implement-misc-r3/_mill/briefs/review-plan-holistic-r1.out.md`
