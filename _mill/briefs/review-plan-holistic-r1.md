...
You are an independent plan reviewer for **git-pr: gh pr create fails on GraphQL 5xx with no REST fallback documented**.
...
- /home/knatte/Code/millhouse/wts/git-pr-graphql-5xx-fallback/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/git-pr-graphql-5xx-fallback/_mill/plan/01-rest-fallback.md
- /home/knatte/Code/millhouse/wts/git-pr-graphql-5xx-fallback/plugins/mill/skills/git-pr/SKILL.md

## Plan files to review
- Overview: `/home/knatte/Code/millhouse/wts/git-pr-graphql-5xx-fallback/_mill/plan/00-overview.md`
- Batches:
- `/home/knatte/Code/millhouse/wts/git-pr-graphql-5xx-fallback/_mill/plan/01-rest-fallback.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/git-pr-graphql-5xx-fallback/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/git-pr-graphql-5xx-fallback/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/git-pr-graphql-5xx-fallback/_mill/briefs/review-plan-holistic-r1.out.md`
