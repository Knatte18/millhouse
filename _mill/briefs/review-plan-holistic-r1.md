...
You are an independent plan reviewer for **mill-merge-in --recompute-baseline crashes uncaught on absent status.md**.
...
- /home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/_mill/plan/00-overview.md
- /home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/_mill/plan/01-crash-fix.md
- /home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/plugins/mill/scripts/millpy-merge-in-subagent.py
- /home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/plugins/mill/unit_tests/test-millpy-merge-in-subagent.py
- /home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/plugins/mill/scripts/_paths.py

## Plan files to review
- Overview: `/home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/_mill/plan/00-overview.md`
- Batches:
- `/home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/_mill/plan/01-crash-fix.md`
...
Write your full report to this file: /home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/_mill/briefs/review-plan-holistic-r1.out.md`
