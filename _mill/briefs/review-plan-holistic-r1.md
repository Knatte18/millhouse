...
You are an independent plan reviewer for **mill-plan Entry step 2: _config.load_config called with hub_root/worktree_root swapped vs its own signature**.
...
- /home/knatte/Code/millhouse/wts/mill-plan-entry-config-load-args-swapped/_mill/plan/00-overview.md
- /home/knatte/Code/millhouse/wts/mill-plan-entry-config-load-args-swapped/_mill/plan/01-fix-call-site-keyword-args.md
- /home/knatte/Code/millhouse/wts/mill-plan-entry-config-load-args-swapped/plugins/mill/skills/mill-plan/SKILL.md
- /home/knatte/Code/millhouse/wts/mill-plan-entry-config-load-args-swapped/_mill/discussion.md

## Plan files to review
- Overview: `/home/knatte/Code/millhouse/wts/mill-plan-entry-config-load-args-swapped/_mill/plan/00-overview.md`
- Batches:
- `/home/knatte/Code/millhouse/wts/mill-plan-entry-config-load-args-swapped/_mill/plan/01-fix-call-site-keyword-args.md`
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/mill-plan-entry-config-load-args-swapped/_mill/briefs/review-plan-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/mill-plan-entry-config-load-args-swapped/_mill/briefs/review-plan-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/mill-plan-entry-config-load-args-swapped/_mill/briefs/review-plan-holistic-r1.out.md`
