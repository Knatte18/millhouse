...
You are an independent plan reviewer for **_plan_validate.py context-completeness: path-token exemption list gaps**.
...
Every unprefixed path below is relative to `/home/knatte/Code/millhouse/wts/plan-validate-context-completeness-path-branch-gaps`.
- `wiki/` paths are relative to `/home/knatte/Code/millhouse/wiki`

## Files included (N=7)

- _mill/plan/00-overview.md
- _mill/plan/01-context-completeness-exemptions.md
- _mill/plan/02-context-completeness-exemptions-tests.md
- _mill/plan/03-context-completeness-exemptions-docs.md
...
Write your full report to this file: /home/knatte/Code/millhouse/wts/plan-validate-context-completeness-path-branch-gaps/_mill/briefs/review-plan-holistic-r3.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/knatte/Code/millhouse/wts/plan-validate-context-completeness-path-branch-gaps/_mill/briefs/review-plan-holistic-r3.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/knatte/Code/millhouse/wts/plan-validate-context-completeness-path-branch-gaps/_mill/briefs/review-plan-holistic-r3.out.md`
