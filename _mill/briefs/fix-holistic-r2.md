...
- **Holistic review file:** `C:\Code\millhouse\wts\mill-infra-and-path-fixes\_mill\reviews\20260615-120759-code-review-r2.md`
...
Load the **mill-receiving-review** skill before reading any finding in `C:\Code\millhouse\wts\mill-infra-and-path-fixes\_mill\reviews\20260615-120759-code-review-r2.md`. This is non-negotiable.
...
```json
{"status":"success","commit_sha":"<last-HEAD-sha>","session_id":"b9428c80-acfd-4c40-90ed-777c8ad410a8"}
```
...
**`session_id` MUST be exactly `b9428c80-acfd-4c40-90ed-777c8ad410a8` (the UUID shown in the example above — it was injected into this brief when it was rendered). Copy it verbatim.**

or, when stuck:

```json
{"status":"stuck","stuck_type":"transient|verify|logic","reason":"<one-line>","commit_sha":"<last-HEAD-sha>","session_id":"b9428c80-acfd-4c40-90ed-777c8ad410a8"}
```
**Do not wrap the JSON in a code block. Output it as a bare line — no backticks, no fence. Anything other than a bare JSON line is treated as `stuck_type: logic`.**
