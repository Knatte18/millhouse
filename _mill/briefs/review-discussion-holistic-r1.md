...
You are an independent discussion reviewer for **mill-merge-in --recompute-baseline crashes uncaught on absent status.md**.
Round **1**.
...
Read the discussion at `/home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/_mill/discussion.md`. The discussion file is the authoritative scope. Read files referenced in `## Technical Context` to verify claims.
...
Write your full report to this file: /home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/_mill/briefs/review-discussion-holistic-r1.out.md

Any format the prompt above asks for (including a `MILL_REVIEW_BEGIN` / `MILL_REVIEW_END` wrapped report) is the content of /home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/_mill/briefs/review-discussion-holistic-r1.out.md -- write it there, not into chat.

Your final chat message must be exactly one line and nothing else: `WROTE /home/hanf/Code/millhouse/wts/mill-merge-in-recompute-baseline-crash/_mill/briefs/review-discussion-holistic-r1.out.md`
