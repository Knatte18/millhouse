...
You are an independent discussion reviewer for **Fix nested-junction teardown, Windows verify gate in merge-in, and review-plan --round threading**. Round **1**. Reviewer model: **opushigh**.
