...
### [NIT:consistency] Card 1 leaves "Step 4.5" label after renumbering marker to 3.5
...
### [NIT:consistency] Batch 1 Scope asserts a false Batch-2 dependency/overlap
**Demoted-from:** BLOCKING
...
### [NIT:consistency] Overview Shared Decision mis-cites Card 6 for the #861 fix
**Demoted-from:** BLOCKING
