...
### [NIT:consistency] "no hook anywhere" test spec contradicts byte-for-byte move
...
### [NIT:decision] Disposition of pre-`## Entry` preamble (title/banner/role text) unstated
**Demoted-from:** BLOCKING
