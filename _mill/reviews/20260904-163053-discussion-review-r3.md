...
### [NIT:consistency] card-numbering claim overstates actual enforcement
...
### [NIT:decision] `_extract_requirements_text`'s truncation risk vs. new fence tracking left unaddressed
**Demoted-from:** BLOCKING
