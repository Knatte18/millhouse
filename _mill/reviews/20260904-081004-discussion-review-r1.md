...
### [NIT:decision] #973's move-target for the orphaned card file is unnamed
...
### [NIT:consistency] Technical Context misattributes `_plan_dag` line numbers, contradicting Scope's own citation
**Demoted-from:** BLOCKING
