...
### [NIT:consistency] Card 7 wires new helper calls with no inline `signature:` line
...
### [NIT:consistency] Card 5's new subsection omits the same `signature:` convention
**Demoted-from:** BLOCKING
