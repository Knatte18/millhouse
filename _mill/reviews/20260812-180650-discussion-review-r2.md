...
### [NIT:consistency] "round: 0 fix" decision contradicts itself on which sites thread `args.round`
...
### [NIT:scope] `review-output.schema.md` update is described but absent from Scope > In:
**Demoted-from:** BLOCKING
