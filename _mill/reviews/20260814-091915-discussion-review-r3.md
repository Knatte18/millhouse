...
### [NIT:consistency] Python's "good" docstring example still narrates how-it-works
...
### [NIT:scope] Python module-docstring header prose not trimmed like Go's parallel section
**Demoted-from:** BLOCKING
