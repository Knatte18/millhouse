...
### [NIT:consistency] "0.6" inner dispatch drops the pre-edit PYTHONPATH worktree override
...
### [NIT:consistency] "0.5" halts on `dead` liveness while "0.6" treats identical case as no-op
**Demoted-from:** BLOCKING
