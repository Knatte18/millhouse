...
### [NIT:consistency] Card 1's quoted "current value" omits the frontmatter's trailing sentence
...
### [NIT:consistency] Card 2 prescribes an unprecedented `Skill(plugin:name)` call syntax
**Demoted-from:** BLOCKING
