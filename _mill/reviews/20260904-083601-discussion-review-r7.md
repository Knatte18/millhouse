...
### [NIT:consistency] Resolvability-gate walk names 2 roots, canonicalization assumes 3
...
### [NIT:consistency] Technical Context overclaims reuse of creates/deletes/moves_targets for symbols
**Demoted-from:** BLOCKING
